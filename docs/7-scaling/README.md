...
[Stage 4](../4-load/README.md) measured what the minimum deployment can carry and where it bends. Past that point
requests queue, latency climbs, and the SLO from [stage 6](../6-slo/README.md) starts to burn. Nothing adds capacity:
...
Previous: [SLO](../6-slo/README.md) · Next: [Tracing](../8-tracing/README.md)
