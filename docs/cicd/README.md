...
After [stage 2](../gitops/README.md) the cluster runs whatever Git says. But the images Git points at were built
...
[stage 1 §8 OIDC federation](../terraform/concepts.md#8-oidc-federation-for-ci).*
...
([concepts §8](../terraform/concepts.md#8-oidc-federation-for-ci)): naming *where* without naming *which*.
...
Previous: [GitOps](../gitops/README.md) · Next: [Load](../load/README.md)
