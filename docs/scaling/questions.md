...
Bộ liên quan: [tổng quan project](../common/questions.md), [Load](../load/questions.md),
[progressive delivery](../delivery/questions.md), [managed so với self-managed](../aws/questions.md). Ý tưởng của
