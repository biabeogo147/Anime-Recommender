...
([stage 5, 3.4](../5-delivery/guide.md#3-criterion-8--the-promotion-drill--ops-window-1)). Then:
...
of [stage 5, section 2](../5-delivery/guide.md#2-fake-mode-for-the-drills--ops), if it is not already. Do not start that
...
[Runbook](../runbooks/anime-api.md) · Previous: [Delivery guide](../5-delivery/guide.md)
