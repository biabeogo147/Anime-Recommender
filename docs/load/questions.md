...
Bộ liên quan: [tổng quan project](../common/questions.md), [SLO](../slo/questions.md),
[scaling](../scaling/questions.md), [progressive delivery](../delivery/questions.md). Ý tưởng của stage:
