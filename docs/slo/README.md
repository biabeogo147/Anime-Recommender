...
After [stage 5](../delivery/README.md) a bad release is caught during its canary. Nothing else is. A provider outage,
a slow afternoon, a regression that only shows under real traffic — the system would notice none of them until
someone looked at a graph. And [stage 4](../load/README.md) left a measured latency target, **T**, that nothing
enforces.
...
- **Prometheus and Alertmanager have no login** ([stage 2](../gitops/README.md#known-limits)): anyone on the VPN can
  silence a page.
...
Previous: [Delivery](../delivery/README.md) · Next: [Scaling](../scaling/README.md)
