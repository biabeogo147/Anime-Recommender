...
At the end of [stage 1](../1-terraform/README.md) there is a cluster reachable through a tunnel, with Argo CD
...
[stage 1](../1-terraform/README.md#decision-4--six-identities-and-none-of-them-is-a-key): three named secrets,
...
Previous: [Terraform](../1-terraform/README.md) · Next: [CI/CD](../3-cicd/README.md)
